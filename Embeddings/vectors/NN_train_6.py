...
and take the mean. We learn a exponential weight function through an exponentialWeightsDotMeanLayer.
...
class NN6():
    def __init__(self):
        ...
        self.model1 = NN_layers.exponentialWeightsDotMeanLayer(self.numpy_rng, self.theano_rng, self.x1, INPUT_SHAPE,
                                                             self.l1, max_length=35, n_out=OUTPUT_SHAPE[1], batch_size=BATCH_SIZE, W=None)
        self.model2 = NN_layers.exponentialWeightsDotMeanLayer(self.numpy_rng, self.theano_rng, self.x2, INPUT_SHAPE,
